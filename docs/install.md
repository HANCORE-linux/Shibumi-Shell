...
> [!NOTE]
> `0.1.1-beta.15` is a local candidate and is not published to AUR. This is
...
For a trusted source checkout (supported predecessors: tags v0.1.1-beta.11 through v0.1.1-beta.14.1):

...
mappings=(
  ...
  "shared/presentation/ShibumiButtonGroup.qml:menu/ShibumiButtonGroup.qml"
  "shared/presentation/ShibumiButtonGroup.qml:hancore.shibumi.menu/ShibumiButtonGroup.qml"
  "shared/presentation/ShibumiDropdown.qml:menu/ShibumiDropdown.qml"
  "shared/presentation/ShibumiDropdown.qml:hancore.shibumi.menu/ShibumiDropdown.qml"
  "shared/presentation/ShibumiTextField.qml:menu/ShibumiTextField.qml"
  "shared/presentation/ShibumiTextField.qml:hancore.shibumi.menu/ShibumiTextField.qml"

...
FocusScope {
  ...
  function boundedFailureCode(code) {
    ...
    const allowed = [
      ...
      "authorization-failed", "secret-response", "secret-response-type",
      "secret-response-empty", "secret-response-groups", "secret-fields-empty",
      "secret-psk-missing", "secret-extra-fields", "secret-value-invalid",
      "connection-changed",

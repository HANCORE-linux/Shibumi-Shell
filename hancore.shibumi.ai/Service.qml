...
Item {
  ...
  Loader {
    id: claudeLoader
    active: root.runtimeProbesEnabled && root.detectionReady
      && root.claudeAvailable && String(root.claudeSource)
  ...
  Loader {
    id: codexLoader
    active: root.runtimeProbesEnabled && root.detectionReady
      && root.codexAvailable && String(root.codexSource)
  ...
  OpenCodeProvider {
    id: openCodeProvider
    enabled: root.runtimeProbesEnabled && root.detectionReady
      && root.openCodeAvailable

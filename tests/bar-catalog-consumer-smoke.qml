...
ShellRoot {
  ...
  QtObject {
    ...
    property var manifest: ({ id: "hancore.shibumi.bar",
      version: "0.1.1-beta.15.1", kinds: ["bar"] })
  ...
  Component {
    ...
    Item {
      ...
      property var providerManifest: ({ id: "hancore.shibumi.control-center",
        version: "0.1.1-beta.15.1", kinds: ["service"] })
    ...
    onTriggered: {
      ...
      if (root.stage === 0) {
        ...
        root.bar = barFactory.createObject(root, {
          ...
          shell: scopedBarHost,
          manifest: ({ id: "hancore.shibumi.bar", version: "0.1.1-beta.15.1",
            kinds: ["bar"] }),
        ...
        fakePluginRegistry.manifest = ({ id: "hancore.shibumi.bar",
          version: "0.1.1-beta.15.1-metadata", kinds: ["bar"] })
        ...
        fakePluginRegistry.manifest = ({ id: "hancore.shibumi.bar",
          version: "0.1.1-beta.15.1-shutdown", kinds: ["bar"] })

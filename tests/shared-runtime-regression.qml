...
ShellRoot {
  ...
  Item {
    ...
    Shared.Provider {
      ...
      manifest: ({id: "hancore.shibumi.bar", version: "0.1.1-beta.15", kinds: ["bar"]})
    }
  }
  ...
  function advance() {
    ...
    if (phase === 0) {
      ...
      state.manifest = {id: "hancore.shibumi.state", version: "0.1.1-beta.15", kinds: ["service"]}
      ...
      first.injectedManifest = {id: "hancore.shibumi.audio", version: "0.1.1-beta.15", kinds: ["service"]}
      ...
      second = serviceFactory.createObject(null, {injectedHost: audioApi,
        injectedManifest: {id: "hancore.shibumi.audio", version: "0.1.1-beta.15", kinds: ["service"]}})
      ...
      const malformed = {version: "0.1.1-beta.15", kinds: ["service"]}

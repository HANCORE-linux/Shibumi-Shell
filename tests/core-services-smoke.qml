...
ShellRoot {
  ...
  Telemetry.Service {
    ...
    manifest: ({id: "hancore.shibumi.telemetry", version: "0.1.1-beta.14", kinds: ["service"]})
  }
  ...
  Cpu.Service {
    ...
    manifest: ({id: "hancore.shibumi.cpu", version: "0.1.1-beta.14", kinds: ["service"]})
  }
  ...
  PowerState.Service {
    id: power
    shell: fakeShell
    manifest: ({id: "hancore.shibumi.power-state", version: "0.1.1-beta.14", kinds: ["service"]})

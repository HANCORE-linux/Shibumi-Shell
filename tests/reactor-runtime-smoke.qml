...
ShellRoot {
  ...
  readonly property var manifest: ({id: "hancore.shibumi.reactor", version: "0.1.1-beta.15.1", kinds: ["service"]})
  ...
  SuiteRuntime.Provider {
    pluginId: "hancore.shibumi.state"; implementationVersion: "0.1.1-beta.15.1"
    owner: state; host: root.stateEnabled ? stateHost : null
    manifest: ({id: "hancore.shibumi.state", version: "0.1.1-beta.15.1", kinds: ["service"]})
  }
  SuiteRuntime.Provider {
    pluginId: "hancore.shibumi.audio"; implementationVersion: "0.1.1-beta.15.1"
    owner: audio; host: root.audioEnabled ? audioHost : null
    manifest: ({id: "hancore.shibumi.audio", version: "0.1.1-beta.15.1", kinds: ["service"]})
  }
